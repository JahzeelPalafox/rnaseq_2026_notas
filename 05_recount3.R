...
human_projects <- available_projects() # Esta función musestra los proyectos disponibles en recount3, incluyendo información sobre
# el tipo de proyecto, el organismo, el número de muestras, etc.

## OBservamo el objeto
Clase(human_projects)
...
# Esto crea dos assays porque el assay original se llama "raw_counts" y el nuevo assay se llama "counts".
